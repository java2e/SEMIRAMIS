...
public class HitamView {
	...
	private Double devletReddiyatTutar;
	private Double muvvekkilReddiyatTutar;
	private int sasaDurum;
	private int devletDurum;
	private int muvvekkilDurum;
	...
	public Double getDevletReddiyatTutar() {
		return devletReddiyatTutar;
	}

	public void setDevletReddiyatTutar(Double devletReddiyatTutar) {
		this.devletReddiyatTutar = devletReddiyatTutar;
	}

	public Double getMuvvekkilReddiyatTutar() {
		return muvvekkilReddiyatTutar;
	}

	public void setMuvvekkilReddiyatTutar(Double muvvekkilReddiyatTutar) {
		this.muvvekkilReddiyatTutar = muvvekkilReddiyatTutar;
	}
	...
	public int getMuvvekkilDurum() {
		return muvvekkilDurum;
	}

	public void setMuvvekkilDurum(int muvvekkilDurum) {
		this.muvvekkilDurum = muvvekkilDurum;
	}
