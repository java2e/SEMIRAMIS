...
public class IcraDosyaIslemleriBean {
	...
	private String Ev="img/acikgri.png", Arac="img/acikgri.png", Para="img/acikgri.png", Haciz="img/acikgri.png", Itiraz="img/acikgri.png",
			Istahbarat="img/acikgri.png",Bila="img/acikgri.png", Hitam="img/acikgri.png", Temlik="img/acikgri.png",Vefat="img/acikgri.png"  ;
	
	private String Arac_1="img/acikgri.png", Arac_2="img/acikgri.png",Arac_3="img/acikgri.png",Arac_4="img/acikgri.png";
	private String Ev_1="img/acikgri.png",Ev_2="img/acikgri.png",Ev_3="img/acikgri.png",Ev_4="img/acikgri.png";
	
	private String kart_1="img/HSBC-ADVANCE.jpg", kart2="img/HSBC-GOLD.jpg", kart_3="img/HSBC-PLATİNİUM.jpg", kart_4="HSBC-PREMİER.jpg";
	...
	if(icradosyaID==0)
	{
	        FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "ÜZGÜNÜZ !!!", "Girmiş olduğunuz Kriterlere Uygun Kayıt Bulunamamıştır.");
	...
	public void GelismisListe(int id) throws Exception{
		...
		if(icradosyaID==0)
		{
		        FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Üzgünüz !!!", "Girmiş Olduğunuz Kritere Uygun Kayıt Bulunamamıştır.");
			    RequestContext.getCurrentInstance().showMessageInDialog(message);
	...
	public void HesapGetir() throws Exception{
		if(HesapTumId==99){
			...
			for (int i = 1; i < hesaplarlistesi.size(); i++) {
				...
				tmpHesap.setAsil_alacak(	(tmpHesap.getAsil_alacak()+ hesapdao.Liste(hesaplarlistesi.get(i).getHesapId()).getAsil_alacak()));
				tmpHesap.setGecikme_faizi( tmpHesap.getGecikme_faizi() + hesapdao.Liste(hesaplarlistesi.get(i).getHesapId()).getGecikme_faizi() );
				tmpHesap.setTemerrut_faizi( tmpHesap.getTemerrut_faizi() + hesapdao.Liste(hesaplarlistesi.get(i).getHesapId()).getTemerrut_faizi());
				tmpHesap.setFaiz_gider_vergisi( tmpHesap.getFaiz_gider_vergisi() + hesapdao.Liste(hesaplarlistesi.get(i).getHesapId()).getFaiz_gider_vergisi());
				tmpHesap.setMasraf_tutari(tmpHesap.getMasraf_tutari() + hesapdao.Liste(hesaplarlistesi.get(i).getHesapId()).getMasraf_tutari());
			}
	...
	public void Hesapla() throws Exception
	{
		...
		BaglantiDAO baglantidao = new BaglantiDAO();
		Date bugun = new Date();
		//hesaplistesi.setId( baglantidao.Listele(pelops.controller.AktifBean.getIcraDosyaID()).getHesaplamaID());
		...
		if(hesaplistesi.getTakip_alacagi()<=vekaletsinirlar.Liste(yil).getSinir_1()){
			hesaplistesi.setVekalet_ucreti(hesaplistesi.getTakip_alacagi()*vekaletsinirlar.Liste(yil).getYuzde_1()/100);
										...
										if(hesaplistesi.getTakip_alacagi()<=400000){
											hesaplistesi.setVekalet_ucreti(14400+(hesaplistesi.getTakip_alacagi()-150000)*6/100);
													...
													if(hesaplistesi.getTakip_alacagi()<=1000000){
														hesaplistesi.setVekalet_ucreti(29400+(hesaplistesi.getTakip_alacagi()-400000)*4/100);
													}else{
																if(hesaplistesi.getTakip_alacagi()<=1750000){
																	hesaplistesi.setVekalet_ucreti(53400+(hesaplistesi.getTakip_alacagi()-1000000)*3/100);
																}else{
																	
																			if(hesaplistesi.getTakip_alacagi()<=3000000){
																				hesaplistesi.setVekalet_ucreti(75900+(hesaplistesi.getTakip_alacagi()-1750000)*1.5/100);
																			}else{
																				hesaplistesi.setVekalet_ucreti(94650+(hesaplistesi.getTakip_alacagi()-3000000)*1/100);
		...
		if( sonTarih==null || ilkTarih==null)	Fark=0;
		else
		...
		hesaplistesi.setToplam_alacak(hesaplistesi.getTakip_alacagi()+hesaplistesi.getVekalet_ucreti()+hesaplistesi.getTakip_faizi()+
				hesaplistesi.getFaiz_gider_vergisi2()+hesaplistesi.getDiger_harclar()+hesaplistesi.getMasraf_tutari()+hesaplistesi.getTahsil_harci());
		
		
		hesaplistesi.setKalan_alacak(hesaplistesi.getToplam_alacak()- hesaplistesi.getTahsilat_tutari()-hesaplistesi.getIndirim_tutari());
	...
	public void itirazDurum(){
		...
		try {
			...
			else this.Itiraz="img/acikgri.png";
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void bilaDurum(){
		...
		try {
			...
			else this.Bila="img/acikgri.png";
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void hitamDurum(){
		...
		try {
			...
			else this.Hitam="img/acikgri.png";
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void maasDurum(){
		...
		try {
			...
			else this.Para="img/acikgri.png";
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public String hacizDurum(){
		...
		try {
			...
			else this.Haciz="img/acikgri.png";
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
...
//		
//		switch (deger) {
//		case 1: RequestContext.getCurrentInstance().execute("PF('dlgPenceresi').show()");break;
//		case 2: 
//			this.dlgURL = "dlg_harc_bilgisi_kaydi.xhtml";
//			RequestContext.getCurrentInstance().execute("PF('dlgHacizBilgisi').show()");
//		
//			break;
//		case 3: RequestContext.getCurrentInstance().execute("PF('dlgPenceresi').show()");break;
//		case 4: RequestContext.getCurrentInstance().execute("PF('dlgPenceresi').show()");break;
//		case 5: RequestContext.getCurrentInstance().execute("PF('dlgPenceresi').show()");break;
//		case 6: RequestContext.getCurrentInstance().execute("PF('dlgPenceresi').show()");break;
//		case 7: RequestContext.getCurrentInstance().execute("PF('dlgPenceresi').show()");break;
//		case 8: RequestContext.getCurrentInstance().execute("PF('dlgPenceresi').show()");break;
//		case 9: RequestContext.getCurrentInstance().execute("PF('dlgPenceresi').show()");break;
//		case 10: RequestContext.getCurrentInstance().execute("PF('dlgPenceresi').show()");break;
//		case 11: RequestContext.getCurrentInstance().execute("PF('dlgPenceresi').show()");break;
//		case 12: RequestContext.getCurrentInstance().execute("PF('dlgPenceresi').show()");break;
//		case 13: RequestContext.getCurrentInstance().execute("PF('dlgPenceresi').show()");break;
//		case 14: RequestContext.getCurrentInstance().execute("PF('dlgPenceresi').show()");break;
//		
//		
//		
//
