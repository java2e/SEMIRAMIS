...
public class MuameleAnaliziBean {
	...
	Date gelisTarihi1= new Date(oldDate), gelisTarihi2=new Date(), kesinlesmeTarihi1=new Date(oldDate), kesinlesmeTarihi2=new Date();
	...
	public void setMuameleAnaliziListesi(
			ArrayList<MuameleAnalizi> muameleAnaliziListesi) {
	...
	public MuameleAnaliziBean() throws Exception{
		muameleAnaliziListesi = new ArrayList<MuameleAnalizi>();
			...
			muameleAnaliziListesi = mudao.Listele(icraDosyaNo, muvekkilAdi,icraMudurlugu, dosyaTipi, 
					borcTipi,takipTipi,riskYoneticisi,gelisTarihi1,gelisTarihi2, kesinlesmeTarihi1,kesinlesmeTarihi2 );
